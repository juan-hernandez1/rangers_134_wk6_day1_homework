...
# establish our base directory so whenever we use "." to reference any location in our app it knows we are referencing rangers_shop folder
basedir = os.pathabsparth(os.path.dirname(__file__))
